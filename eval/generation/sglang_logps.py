...
def generate(
    ...
    pickle.dump(all_outputs, open('/path/to/eval/generation/rebuattal/outputs_ori_2.pkl', 'wb'))
    end_time = time.time()
    ...
    pickle.dump(outputs, open('/path/to/eval/generation/rebuattal/outputs_ori.pkl', 'wb'))
