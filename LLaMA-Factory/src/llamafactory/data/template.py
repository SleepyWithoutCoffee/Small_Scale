...
register_template(
    ...
    format_user=StringFormatter(slots=["<｜User｜>{{content}}<｜Assistant｜>"]),
    format_assistant=StringFormatter(slots=["{{content}}<｜end▁of▁sentence｜>"]),
    format_system=StringFormatter(slots=["<｜begin▁of▁sentence｜>{{content}}"]),
    format_function=FunctionFormatter(slots=["{{content}}<｜end▁of▁sentence｜>"], tool_format="qwen"),
    format_observation=StringFormatter(
        slots=["<｜tool▁outputs▁begin｜><｜tool▁output▁begin｜>{{content}}<｜tool▁output▁end｜><｜tool▁outputs▁end｜>"]
    ),
    format_tools=ToolFormatter(tool_format="qwen"),
    default_system="",
