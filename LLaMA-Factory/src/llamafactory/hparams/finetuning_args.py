...
class RLHFArguments:
    ...
    pref_loss: Literal["sigmoid", "hinge", "ipo", "kto_pair", "orpo", "simpo", "simper", "lcpo"] = field(
        default="sigmoid",
...
class FinetuningArguments(
    ...
    def __post_init__(self):
        ...
        self.use_ref_model = self.stage == "dpo" and self.pref_loss not in ["orpo", "simpo", "simper", "lcpo"]
